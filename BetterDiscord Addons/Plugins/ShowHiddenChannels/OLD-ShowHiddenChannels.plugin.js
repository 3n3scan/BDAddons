 ...
 * @author 3n3scan
 * @authorId 773514870409789471
 * @version 4.8.4
 * @description Displays all hidden Channels, which can't be accessed due to Role Restrictions, this won't allow you to read them (impossible)
 * @invite PKAJJPCJsS
 * @donate https://www.paypal.me/EnesCanEryalcin
 * @patreon https://patreon.com/3n3scan
 * @website https://github.com/3n3scan
 * @source https://github.com/3n3scan/BDAddons/Plugins/ShowHiddenChannels/
 * @updateUrl https://github.com/3n3scan/BDAddons/Plugins/ShowHiddenChannels/ShowHiddenChannels.plugin.js
 */
				...
				let processCategory = (category, insertChannelless) => {
					...
					if (channelArray.length) {
						for (let n of channelArray) if ((n.renderLevel == renderLevels.CAN_NOT_SHOW || n._hidden) && e.instance.props.selectedVoiceChannelId != n.record.id) {
							...
							if (hiddenChannelCache[e.instance.props.guild.id].indexOf(n.record.id) == -1) hiddenChannelCache[e.instance.props.guild.id].push(n.retrcord.id);
						}
